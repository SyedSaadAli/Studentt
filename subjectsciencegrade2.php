    ...
    <div class="container" style="background: url('bgimage/subject.png');background-repeat: no-repeat;background-size: 100% 100%;">
        ...
        <div class="vision ">
           ...
           <div class="scontentbox">
            ...
            <ul>
                <li><a href="Grade2/lessons/Science/1.ppsx" target="_blank">أسماء الحيوانات </a></li>
                <li><a href="Grade2/lessons/Science/2.mp4" target="_blank">درس الطقس  </a></li>
                <li><a href="Grade2/lessons/Science/3.pptx" target="_blank">درس أنواع الحيوانات  </a></li>
                <li><a href="Grade2/lessons/Science/4.pdf" target="_blank">كلمات الطقس</a></li>
