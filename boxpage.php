           ...
           <div class="subjectcontainer">
            <form action="cartpagepayment.php" method="POST" enctype="multipart/form-data">
                <span class="subject">
                    ...
                    <p name="Des" id="para1" type="text" style="font-size: 10px;">Box 1</p>
                ...
                <span class="subject">
                    ...
                    <p name="g2" type="text" style="font-size: 10px;">Box 2</p>
                ...
                <span class="subject">
                    ...
                    <p name="g3" type="text" style="font-size: 10px;">Box 3</p>
            ...
            <div class="checklist">
                   ...
                   <br>
                    <button style="width: 10%; height: 10%; padding:5px 7px; background-color:green; color:white; font-weight:600;" type="submit" value="Confirm" name="submit">Confirm</button>
                </form>
            </div>
